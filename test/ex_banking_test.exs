defmodule ExBankingTest do
  ...
  test ":wrong_arguments in create_user" do
    assert ExBanking.create_user(:bob) == :wrong_arguments
    assert ExBanking.create_user(100) == :wrong_arguments
    assert ExBanking.create_user(["Bob"]) == :wrong_arguments
    assert ExBanking.create_user("Bob") == :ok
  end
  ...
  test ":wrong_arguments in deposit" do
    ...
    assert ExBanking.deposit("Bob", "100", "RUB") == :wrong_arguments
    assert ExBanking.deposit(:Bob, 100, "RUB") == :wrong_arguments
    assert ExBanking.deposit("Bob", 100, :RUB) == :wrong_arguments
  ...
  test ":wrong_arguments in withdraw" do
    ...
    assert ExBanking.withdraw(:Bob, 5, "RUB") == :wrong_arguments
    assert ExBanking.withdraw("Bob", "5", "RUB") == :wrong_arguments
    assert ExBanking.withdraw("Bob", 5, :RUB) == :wrong_arguments
    assert ExBanking.withdraw("Bob", 5, "RUB") == 95
  end
  ...
  test ":wrong_arguments in get_balance" do
    ...
    assert ExBanking.get_balance(:Bob, "RUB") == :wrong_arguments
    assert ExBanking.get_balance("Bob", :RUB) == :wrong_arguments
  end
  ...
  test ":wrong_arguments in send" do
    ...
    assert ExBanking.send(:Bob, "Martin", 10, "RUB") == :wrong_arguments
    assert ExBanking.send("Bob", :Martin, 10, "RUB") == :wrong_arguments
    assert ExBanking.send("Bob", "Martin", "10", "RUB") == :wrong_arguments
    assert ExBanking.send("Bob", "Martin", 10, :RUB) == :wrong_arguments
    assert ExBanking.get_balance("Bob", "RUB") == 100
  ...
  test ":sender_does_not_exist error" do
    ...
    assert ExBanking.send("Bob", "Martin", 10, "RUB") == :sender_does_not_exist
  ...
  test ":receiver_does_not_exist error" do
    ...
    assert ExBanking.send("Bob", "Martin", 10, "RUB") == :receiver_does_not_exist
    assert ExBanking.get_balance("Bob", "RUB") == 100
  end
end
